...
public class GameModel implements Cloneable, Serializable {
    ...
    public GenericLinkedStack<Object> undoStack = new GenericLinkedStack<Object>();

    public GenericLinkedStack<Object> redoStack = new GenericLinkedStack<Object>();
   ...
   /**
    ...
    //Overriding the method cloneable
    public Object clone() throws CloneNotSupportedException{  
        GameModel cloned;
        try{
            cloned = (GameModel) super.clone();
            cloned = new GameModel(sizeOfGame);
            for(int i = 0; i< sizeOfGame; i++){
                for(int j =0; j<sizeOfGame; j++){
                    cloned.model[i][j] = (DotInfo) model[i][j].clone();
                }
            }
            cloned.numberOfSteps = numberOfSteps;
            cloned.currentSelectedColor = currentSelectedColor;
            cloned.numberCaptured = numberCaptured;
        }
    ...
    * 
     ...
     * Getter method for the current number of steps
     * 
     * @return the current number of captured DotInfos
     */ 
    ...
    */   
     ...
     * @return currentSelectedColor
     */   
    public int getNumberCapturedrentSelectedColor() {
        return currentSelectedColor ;
    }
